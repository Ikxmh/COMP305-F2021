...
[CustomEditor(typeof(MovingPlatformControls))]
public class MovingPlatformsControlsEditor : Editor
{
    public override void OnInspectorGUI()
    {
        MovingPlatformControls controller = (MovingPlatformControls)target;
